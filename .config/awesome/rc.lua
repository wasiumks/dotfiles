...
globalkeys = gears.table.join(
    ...
    awful.key({ alt, "Control" }, "l", function() awful.util.spawn("loginctl lock-session") end,
...
awful.spawn("picom --backend glx  --vsync opengl -b")
awful.spawn("setxkbmap -option caps:super")
awful.util.spawn("xinput set-prop 'SynPS/2 Synaptics TouchPad' 344 1")
